...
function AddProduct() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get('https://ecommerce-platform-kfby.onrender.com/Seller/AllCategory');
  ...
  useEffect(() => {
    if (formData.category) {
      const fetchSubcategories = async () => {
        try {
          const response = await axios.get(`https://ecommerce-platform-kfby.onrender.com/Seller/AllSubCategory/${formData.category}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://ecommerce-platform-kfby.onrender.com/Seller/AddProduct', data, {
        headers: {
